...
@section('header')
  <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Editar método de pago</h1>
@endsection
          ...
          <div id="gateway_fields" class="space-y-3 {{ old('requires_gateway', $paymentMethod->requires_gateway) ? '' : 'hidden' }}">
            ...
            @if($paymentMethod->gateway_config)
              <div class="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-3">
                <p class="text-xs font-medium text-neutral-700 dark:text-neutral-300 mb-1">Configuración actual:</p>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
              <p class="text-xs text-blue-800 dark:text-blue-300">
                ...
                Para configurar API keys contacta al administrador del sistema.
              </p>
            </div>
          </div>
        </div>
