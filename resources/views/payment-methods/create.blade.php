...
@section('header')
  <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{{ __('payment_methods.create_title') }}</h1>
@endsection
          ...
          <div id="gateway_fields" class="space-y-3 {{ old('requires_gateway') ? '' : 'hidden' }}">
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
              <p class="text-xs text-blue-800 dark:text-blue-300">
                ...
                {{ __('payment_methods.gateway_info_create') }}
              </p>
            </div>
          </div>
        </div>
