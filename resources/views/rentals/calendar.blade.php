...
@section('header')
  <div class="flex items-center justify-between gap-3">
    <div>
      <h1 class="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-neutral-100">{{ __('rentals.calendar_title') }}</h1>
      <p class="text-sm text-neutral-600 dark:text-neutral-400">{{ __('rentals.calendar_subtitle') }}</p>
    </div>
