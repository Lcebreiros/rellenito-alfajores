...
@section('header')
  <div class="flex items-center gap-3">
    ...
    <div>
      <h1 class="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-neutral-100">Editar reserva #{{ $booking->id }}</h1>
    </div>
  </div>
@endsection
...
<div class="max-w-xl mx-auto px-3 sm:px-6">
  ...
  <div class="container-glass shadow-sm overflow-hidden"
    ...
    <div class="px-5 py-4 border-b border-neutral-200 dark:border-neutral-700">
      <h2 class="text-base font-semibold text-neutral-900 dark:text-neutral-100">Editar reserva</h2>
    </div>
    ...
    <form method="POST" action="{{ route('rentals.bookings.update', $booking) }}" class="p-5 space-y-4">
      ...
      <div>
        ...
        <textarea name="notes" rows="2"
                  ...
                  placeholder="Observaciones...">{{ old('notes', $booking->notes) }}</textarea>
      </div>
