...
<div
  ...
  :class="{
    // success
    'bg-indigo-500 dark:bg-indigo-600': style == 'success',
    // danger
    'bg-red-700 dark:bg-red-700': style == 'danger',
    // warning
    'bg-yellow-500 dark:bg-yellow-600': style == 'warning',
    // default/neutral
    'bg-gray-500 dark:bg-neutral-800': style != 'success' && style != 'danger' && style != 'warning'
  }"
    ...
    <div class="flex items-center justify-between flex-wrap">
      <div class="w-0 flex-1 flex items-center min-w-0">
        <span
          ...
          :class="{
            'bg-indigo-600 dark:bg-indigo-700': style == 'success',
            'bg-red-600 dark:bg-red-700':     style == 'danger',
            'bg-yellow-600 dark:bg-yellow-700': style == 'warning'
          }"
          aria-hidden="true"
        >
          {{-- Íconos por estilo --}}
      ...
      <div class="shrink-0 sm:ms-3">
        <button
          type="button"
          class="-me-1 flex p-2 rounded-md transition focus:outline-none focus:ring-2 focus:ring-white/70 focus:ring-offset-2 dark:focus:ring-offset-neutral-900"
          :class="{
