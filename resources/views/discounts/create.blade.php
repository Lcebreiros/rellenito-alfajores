...
<div class="container mx-auto px-4 py-6 max-w-3xl">
  {{-- Header --}}
  <div class="mb-6">
    <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Crear Descuento</h1>
    <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
      Define un nuevo descuento o bonificación para tus clientes
    </p>
  </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select id="type" name="type" required
              ...
              <option value="free_minutes" {{ old('type') === 'free_minutes' ? 'selected' : '' }}>Minutos gratis (Parking)</option>
