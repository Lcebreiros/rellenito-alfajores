    ...
    <div class="overflow-x-auto">
      <table class="w-full">
        ...
        <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
          @foreach($serviceExpenses->take(10) as $expense)
            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-900/50">
              ...
              <td class="px-6 py-4">
                <span class="inline-flex rounded-full px-2 py-1 text-xs font-medium bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 capitalize">
