<div class="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900 p-6">
  <div class="mb-4">
    <h3 class="text-lg font-semibold text-neutral-900 dark:text-neutral-100">{{ __('products.smgr_title') }}</h3>
    <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
      {{ __('products.smgr_subtitle') }}
    </p>
  </div>
  ...
  @if(empty($recipes))
    <div class="text-center py-8 text-neutral-500 dark:text-neutral-400">
      ...
      <p class="mt-2 text-sm">{{ __('products.smgr_empty') }}</p>
    </div>
  @else
            ...
            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button wire:click="removeSupply({{ $recipe['id'] }})"
                        wire:confirm="{{ __('products.smgr_confirm_remove') }}"
