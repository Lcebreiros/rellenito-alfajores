    ...
    <div class="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/30">
      <div class="flex items-start gap-2">
        ...
        <div class="text-sm text-neutral-700 dark:text-neutral-300">
          Seleccioná solo los módulos que usás en tu negocio. Los módulos fijos (Dashboard, Ventas, Métodos de Pago, Stock, Gastos, Configuración y Soporte) siempre estarán disponibles.
        </div>
      </div>
    </div>
