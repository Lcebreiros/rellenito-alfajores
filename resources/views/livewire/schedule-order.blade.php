<div x-data="{ on: @entangle('enabled') }" class="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
  <div class="px-5 sm:px-6 py-4 border-b border-neutral-100 dark:border-neutral-800/60 flex items-center justify-between">
    <h3 class="text-sm font-semibold text-neutral-900 dark:text-neutral-100">{{ __('orders.edit.schedule_toggle') }}</h3>
  ...
  <div class="px-5 sm:px-6 py-4">
    <div class="grid gap-2" x-show="on" x-cloak>
        <label for="schedule-datetime" class="text-xs text-neutral-600 dark:text-neutral-400">{{ __('orders.edit.scheduled_date') }}</label>
        ...
        <p class="text-[11px] text-neutral-500 dark:text-neutral-400">{{ __('orders.edit.schedule_hint_on') }}</p>
    </div>
    <p class="text-xs text-neutral-500 dark:text-neutral-400" x-show="!on">{{ __('orders.edit.schedule_hint_off') }}</p>
  </div>
</div>
