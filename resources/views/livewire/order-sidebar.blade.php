<div class="relative bg-white dark:bg-neutral-950 rounded-3xl shadow-xl shadow-violet-100/60 dark:shadow-black/40 ring-1 ring-violet-200/30 dark:ring-neutral-800/60 overflow-hidden backdrop-blur-sm max-h-[100dvh] md:max-h-screen lg:max-h-none lg:h-full flex flex-col w-full max-w-full min-w-0">
