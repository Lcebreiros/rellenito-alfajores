<div class="max-w-2xl mx-auto p-6 text-neutral-900 dark:text-neutral-100">
    <div class="bg-white dark:bg-neutral-900 rounded-lg shadow border border-gray-200 dark:border-neutral-800 p-6">
        <h2 class="text-xl font-semibold mb-6 text-neutral-900 dark:text-neutral-100">{{ __('company.branch_create_heading') }}</h2>
        ...
        <form wire:submit.prevent="createBranch">
            ...
            <div class="mb-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-neutral-100 mb-4">{{ __('company.branch_info_title') }}</h3>
                
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">
                            {{ __('company.branch_name_label') }} <span class="text-red-500">*</span>
                        </label>
                        <input type="text"
                               ...
                               placeholder="{{ __('company.branch_name_placeholder') }}">
                        @error('name') 
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">{{ __('company.address_label') }}</label>
                        <textarea wire:model.defer="address"
                                  ...
                                  placeholder="{{ __('company.address_placeholder') }}"></textarea>
                        @error('address') 
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p> 
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">{{ __('company.phone_label') }}</label>
                            <input type="tel"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">{{ __('company.contact_email_label') }}</label>
                            <input type="email"
                                   ...
                                   placeholder="{{ __('company.contact_email_placeholder') }}">
                            @error('contact_email')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">{{ __('company.contact_email_hint') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 border-t border-gray-200 dark:border-neutral-800 pt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-neutral-100 mb-4">{{ __('company.access_section_title') }}</h3>
                
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">
                            {{ __('company.access_email_label') }} <span class="text-red-500">*</span>
                        </label>
                        <input type="email"
                               ...
                               placeholder="{{ __('company.access_email_placeholder') }}">
                        @error('email')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500 mt-1">{{ __('company.access_email_hint') }}</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">
                            {{ __('company.password_label') }} <span class="text-red-500">*</span>
                        </label>
                        <input type="password"
                               ...
                               placeholder="{{ __('company.password_placeholder') }}">
                        @error('password') 
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p> 
                        @enderror
                    </div>
            ...
            <div class="mb-6 border-t border-gray-200 dark:border-neutral-800 pt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-neutral-100 mb-4">{{ __('company.inventory_label') }}</h3>
                <div class="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-800/70">
                    <div class="mr-4">
                        <div class="text-sm font-medium text-gray-900 dark:text-neutral-100">{{ __('company.use_company_inventory') }}</div>
                        <div class="text-xs text-gray-600 dark:text-neutral-400">{{ __('company.use_company_inventory_desc') }}</div>
                    </div>
            ...
            <div class="mb-6 border-t pt-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('company.config_section_title') }}</h3>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('company.user_limit_label') }}</label>
                        <input type="number"
                               min="0"
                               ...
                               placeholder="{{ __('company.user_limit_placeholder') }}">
                        @error('user_limit')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500 mt-1">{{ __('company.user_limit_hint') }}</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2">{{ __('company.initial_status_label') }}</label>
                        <select wire:model.defer="is_active"
                            ...
                            <option value="1">{{ __('company.branch_active') }}</option>
                            <option value="0">{{ __('company.branch_suspended') }}</option>
                        </select>
                        @error('is_active') 
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p> 
                        @enderror
    ...
    <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900 rounded-lg">
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-800 dark:text-blue-200">
                <p class="font-medium mb-2">{{ __('company.info_box_title') }}</p>
                <ul class="list-disc list-inside space-y-1">
                    <li>{{ __('company.info_box_item1') }}</li>
                    <li>{{ __('company.info_box_item2') }}</li>
                    <li>{{ __('company.info_box_item3') }}</li>
                    <li>{{ __('company.info_box_item4') }}</li>
                </ul>
            </div>
        </div>
    </div>
