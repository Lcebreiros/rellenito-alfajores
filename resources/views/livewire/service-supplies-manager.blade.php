<div class="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900 p-6">
  <div class="mb-4">
    <h3 class="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Insumos del Servicio</h3>
    <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
      Asigna los insumos que se utilizan al prestar este servicio. Se descontarán automáticamente del stock.
    </p>
  </div>
  ...
  @if(empty($serviceSupplies))
    <div class="text-center py-8 text-neutral-500 dark:text-neutral-400">
      ...
      <p class="mt-2 text-sm">No hay insumos asignados a este servicio</p>
    </div>
  @else
            ...
            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button wire:click="removeSupply({{ $serviceSupply['id'] }})"
                        wire:confirm="¿Eliminar este insumo del servicio?"
    ...
    <div class="mt-4 rounded-lg border border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-900/20 p-3">
      <div class="flex items-start gap-2">
        ...
        <p class="text-xs text-amber-800 dark:text-amber-300">
          Al prestar este servicio, los insumos se descontarán automáticamente del stock según las cantidades configuradas más el porcentaje de merma.
        </p>
      </div>
    </div>
  @endif
