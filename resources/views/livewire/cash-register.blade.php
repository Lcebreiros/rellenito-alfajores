...
<div class="relative" x-data x-on:click.outside="$wire.set('showOpenForm', false); $wire.set('showMovementForm', false); $wire.set('showCloseForm', false)">

    {{-- Contenedor principal (siempre visible) --}}
    <div class="flex items-center gap-2 px-2.5 py-1.5 rounded-xl border shadow-sm text-xs
                {{ $session?->isOpen()
        ...
        @else
            {{-- Ingreso --}}
            <button wire:click="$set('movementType', 'ingreso'); $set('showMovementForm', true); $set('showCloseForm', false)"
                    ...
                    class="inline-flex items-center justify-center w-6 h-6 rounded-md font-bold transition text-sm
                           ...
                           {{ $showMovementForm && $movementType === 'ingreso' ? 'ring-2 ring-blue-400' : '' }}">
                +
            </button>
            {{-- Egreso --}}
            <button wire:click="$set('movementType', 'egreso'); $set('showMovementForm', true); $set('showCloseForm', false)"
                    ...
                    class="inline-flex items-center justify-center w-6 h-6 rounded-md font-bold transition text-sm
                           ...
                           {{ $showMovementForm && $movementType === 'egreso' ? 'ring-2 ring-orange-400' : '' }}">
                −
            </button>
            {{-- Cerrar caja --}}
            <button wire:click="$set('showCloseForm', true); $set('showMovementForm', false)"
                    ...
                    class="inline-flex items-center justify-center w-6 h-6 rounded-md transition
                           ...
                           {{ $showCloseForm ? 'ring-2 ring-neutral-400' : '' }}">
    ...
    {{-- Panel flotante con formularios (solo cuando hay algún form activo) --}}
    @if($showOpenForm || $showMovementForm || $showCloseForm)
