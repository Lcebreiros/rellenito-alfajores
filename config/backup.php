...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('MAIL_FROM_ADDRESS', 'admin@rellenito.com')),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@rellenito.com'),
                'name' => env('MAIL_FROM_NAME', 'Rellenito Backups'),
            ],
        ],
